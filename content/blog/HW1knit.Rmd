...
This section of the project concerns data wrangling and data visualization with populations of snowshoe hares (Lepus americanus) in Bonanza Creek, Alaska. The study concerns 5 locales in Tanana Valley in central Alaska from study sites Tok in the east to Clear in the west from 1999-2012 with a time horizon of 13 years. 
...
This section of the project concerns principal components analysis (PCA) which is a statistical analysis conducted in R designed to understand the relationships between variables. The dataset used in this project comes from the United States Department of Agriculture (USDA) and concerns information about nutrients towards a variety of vegetables and fruits. 
